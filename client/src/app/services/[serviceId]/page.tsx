...
export default function ServiceDetailPage() {
  ...
  const handleContactExpert = () => {
    setNotificationMessage("Connecting you with our expert...");
    setShowNotification(true);
    setTimeout(() => setShowNotification(false), 3000);
  };
      ...
      <section className="relative pt-32 pb-16 px-6 overflow-hidden h-[60vh]">
        ...
        <div className="absolute inset-6 backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl flex items-center justify-center z-10">
          <div className="text-center text-white max-w-4xl">
            <div className="backdrop-blur-md bg-white/20 border border-white/30 rounded-full px-6 py-3 inline-block mb-6">
            ...
            <div className="relative">
              <div className="bg-white/80 backdrop-blur-sm border border-blue-200/50 rounded-3xl p-8 shadow-xl">
                <img
                  ...
                  alt={service.overview.imageTitle}
                  className="w-full h-80 object-cover rounded-2xl mb-6"
                />
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  {service.overview.imageTitle}
                </h3>
                <p className="text-gray-600 leading-relaxed">
                  {service.overview.imageDescription}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Our {service.title.toLowerCase()} encompasses a full range of
              specialized services, each designed to meet specific industry
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {subService.applications.map((app, idx) => (
                      <span
                        key={idx}
      ...
      <section className="relative py-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight">
              Proven {service.title} Methodology
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Our systematic approach ensures consistent quality, on-time
              delivery, and optimal results for every{" "}
          ...
          <div className="space-y-8">
            {service.processSteps.map((step, index) => (
              <div key={index} className="flex items-start space-x-8 group">
                ...
                <div className="flex-1 bg-white/80 backdrop-blur-sm border border-blue-200/50 rounded-3xl p-8 shadow-lg group-hover:shadow-xl transition-all duration-300">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {service.ctaSection.primaryButton}
            </button>
            <button
            ...
            >
              {service.ctaSection.secondaryButton}
            </button>
          </div>
        </div>
      </section>
