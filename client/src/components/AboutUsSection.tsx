...
export default function AboutUsSection() {
  ...
  return (
    <section className="bg-white py-12 sm:py-16 md:py-24 pb-8 sm:pb-12 px-2 sm:px-4 md:px-24">
      <div className="max-w-8xl mx-auto relative z-10">
        {/* Main Card Section */}
        <div className="bg-white border border-gray-200 rounded-3xl p-6 sm:p-8 md:p-10 lg:p-14 shadow-lg relative overflow-hidden">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            {/* Left Content */}
            <div className="space-y-8">
              <div>
                <p className="text-brand-primary uppercase tracking-wide text-sm font-medium mb-6 bg-brand-light/40 px-4 py-2 rounded-full w-fit border border-brand-light/50">
                  ABOUT US
                </p>
                  ...
                  >
                    ...
                    <div className="bg-gray-50 rounded-2xl p-6 w-[320px] flex-shrink-0 shadow-sm">
                      <p className="text-gray-700 text-sm leading-relaxed mb-6">
                        ...
                        truly impressed by how quickly their strategies turned
                        into real, tangible outcomes, driving measurable growth
                    ...
                    <div className="bg-gray-50 rounded-2xl p-6 w-[320px] flex-shrink-0 shadow-sm">
                      <p className="text-gray-700 text-sm leading-relaxed mb-6">
                        "We faced a turning point and needed expert guidance.
                        They stepped in with a clear vision and strong
                        execution. Their strategies not only solved immediate
                        pain points but created lasting change that boosted our
                        productivity and internal alignment."
                      </p>
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center">
                          <svg
                    ...
                    <div className="bg-gray-50 rounded-2xl p-6 w-[320px] flex-shrink-0 shadow-sm">
                      <p className="text-gray-700 text-sm leading-relaxed mb-6">
                        ...
                        collaborative approach helped align our entire team
                        behind the new direction and goals."
                      </p>
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center">
                          <svg
